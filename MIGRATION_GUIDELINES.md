...
1. **Document in `MIGRATION_ISSUES.md`**
   - Use the template provided
   - Include step, date, status, description, solution, lessons

2. **Update Status**
   - Note the issue in `MIGRATION_STATUS.md`
...
2. Review MIGRATION_STATUS.md for context
...
**Documentation is part of the work**: Keep `MIGRATION_STATUS.md` and `MIGRATION_ISSUES.md` updated as you progress.
